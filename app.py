...
document = 'database.yaml'
db_config = yaml.dump(yaml.full_load(document))

#app.config['SQLALCHEMY_DATABASE_URI'] = db_config['uri']
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:sa@localhost/EmployeeDB'
...
def onedata(id):
    ...
    if request.method == 'GET':
        ...
        print(data)
		# control if exist 3 times: /
        if data == None: return jsonify({})
        dataDict = {
            'id': str(data).split('/')[0],
